...
<a href="${url_for("bronze_signup")}" id="bronze_link">
    ...
    <p align="center">Klik her for at oprette som bronzemedlem</p>
    </div>
</a>
<a href="${url_for("silver_signup")}" id="silver_link">
    ...
    <p align="center">Klik her for at oprette som sølvmedlem</p>
    </div>
</a>
<a href="${url_for("gold_signup")}" id="gold_link">
    ...
    <p align="center">Klik her for at oprette som guldmedlem</p>
    </div>
</a>
